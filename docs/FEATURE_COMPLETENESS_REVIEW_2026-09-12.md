...
| FC10 provider/browser | Typed conversion/wrapper reads, bounded multi-address outpoints and inclusive delta queries, native WS/browser adapters; passive account/chain/disconnect revisions and stale-signature rejection | Remaining reference RPC mapping, integrated WS reconnect/backfill, browser persistence and real extension interoperability remain open |
