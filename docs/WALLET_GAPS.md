...
| Qi wrapping/redemption | Native 20-byte wire/signing, durable sessions, WQI backing/claim/ERC-20/redemption adapter and dust/gas guards | Funded mature output acceptance; subtype-4/6 attribution, current output locks and durable observations are implemented (FC05) |
