...
if __name__ == '__main__':
    ...
    parser.add_argument('--suite', choices=['sdk-utilities', 'sdk-resources', 'browser', 'worker', 'sdk-contract-io', 'sdk-transaction-confirmations', 'sdk-transaction-documents', 'sdk-wordlists', 'sdk-rpc-signer', 'sdk-response-views', 'sdk-provider-events', 'account_wait', 'sdk-legacy-wallets', 'sdk-address-book', 'sdk-worker', 'sdk-contracts', 'sdk-events', 'sdk-keys', 'sdk-backups', 'sdk-allocations', 'sdk-payment-allocations', 'sdk-human-abi', 'sdk-receipts', 'sdk-account-custody', 'sdk-account-backup', 'sdk-contract-code', 'sdk-qi-custody', 'sdk-portable-capture', 'sdk-allocation-merge', 'sdk-account-preflight', 'sdk-recovery', 'sdk-qi-preflight'], default='browser')
